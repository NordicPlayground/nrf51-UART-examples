...
#define MIN_CONN_INTERVAL               800 //16                                          /**< Minimum acceptable connection interval (20 ms), Connection interval uses 1.25 ms units. */
#define MAX_CONN_INTERVAL               1200 //60                                          /**< Maximum acceptable connection interval (75 ms), Connection interval uses 1.25 ms units. */
...
static void uart_init(void)
{
		...
		comm_params.flow_control = APP_UART_FLOW_CONTROL_LOW_POWER;  //APP_UART_FLOW_CONTROL_ENABLED;
